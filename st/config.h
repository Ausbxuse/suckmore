...
static char *font = "JetBrainsMonoNF-Bold:size=13:antialias=true:autohint=true";
//static char *font2 = { "JoyPixels:pixelsize=13:antialias=true:autohint=true" };
//static char *font2 = { "SourceHanSansCN:pixelsize=17:antialias=true:autohint=true", };
//static char *font2 = { "feather:size=13" };
/* Spare fonts */
static char *font2[] = {
    ...
    "Material Design Icons:size=13:antialias=true:autohint=true" ,
    "SourceHanSansCN:pixelsize=17:antialias=true:autohint=true" ,
    "Typicons:pixelsize=17:antialias=true:autohint=true" ,
    "icomoon:pixelsize=17:antialias=true:autohint=true" ,
...
static char *copyoutput2[] = { "/bin/sh", "-c", "copyoutput", "externalpipe", NULL };
